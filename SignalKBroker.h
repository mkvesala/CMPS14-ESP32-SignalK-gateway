...
private:
    ...
    static constexpr float DB_HDG_RAD = 0.001745f;    // 0.1°: deadband threshold for heading
    static constexpr float DB_ATT_RAD = 0.001745f;    // 0.1°: pitch/roll deadband threshold
};
